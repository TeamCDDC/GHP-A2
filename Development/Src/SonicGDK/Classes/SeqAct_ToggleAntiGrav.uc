...
//================================================================================
// Sequence Action Toggle Anti Grav > SequenceAction > SequenceOp >
//     > SequenceObject > Object
//
// A sequence action is a representation of an action that performs a behavior on
// any targeted objects.
// This action gives magnetic boots to the given pawn.
//================================================================================
class SeqAct_ToggleAntiGrav extends SequenceAction;
        ...
        if (Pawn != none && SGDKPlayerPawn(Pawn) != none)
        {
            ...
            if (InputLinks[0].bHasImpulse)
                ...
                if (InputLinks[1].bHasImpulse)
                    ...
                    P.bAntiGravityMode = !P.bAntiGravityMode;
        }
    }
}
...
defaultproperties
{
    ...
    ObjName="Toggle Anti Gravity" //Text label that describes this object.
