...
//================================================================================
// Pawn Knuckles > SGDKPlayerPawn > SGDKPawn > UTPawn > UDKPawn > GamePawn >
//     > Pawn > Actor
//
...
// This class is for Knuckles character.
//================================================================================
class PawnKnuckles extends SGDKPlayerPawn
    placeable;
...
defaultproperties
{
    ...
    FamilyInfoClass=class'FamilyInfoKnuckles'
