...
//================================================================================
// Family Info Sonic > SGDKFamilyInfo > UTFamilyInfo > Object
//
// A FamilyInfo is a structure which stores information about a particular race or
// 'family' (eg. Ironguard Male).
// This subclass is Sonic's.
//================================================================================
class FamilyInfoSonic extends SGDKFamilyInfo;
...
defaultproperties
{
    ...
    DefaultMeshScale=3.25
    BaseTranslationOffset=0.0
    CrouchTranslationOffset=3.0
}
